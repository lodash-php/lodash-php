...
class GetTest extends TestCase
{
    ...
    public function testGetArray(){
        ...
        $this->assertSame($defaultValue, get($sampleArray, "key1.key2.key4", $defaultValue, true),"Default To method 7 failed");
    ...
    public function testDefaultToObject(){
        ...
        $this->assertSame($defaultValue, get($sampleArray, "key1.key2.key4", $defaultValue, true),"Default To method object 7 failed");
